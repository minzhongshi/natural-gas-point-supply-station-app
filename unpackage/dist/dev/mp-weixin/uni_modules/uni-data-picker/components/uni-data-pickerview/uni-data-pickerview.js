  ...
  return common_vendor.e({
    ...
    b: common_vendor.f(_ctx.selected, (item, index, i0) => {
      return common_vendor.e({
        ...
        d: common_vendor.o(($event) => $options.handleSelect(index))
      } : {});
    })
  } : {}, {
    c: common_vendor.f(_ctx.dataList, (child, i, i0) => {
      return common_vendor.e({
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/毕业设计/app/天然气监控APP/uni_modules/uni-data-picker/components/uni-data-pickerview/uni-data-pickerview.vue"]]);
